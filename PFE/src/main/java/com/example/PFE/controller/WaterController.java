...
public class WaterController {
    ...
    public List<WaterMeasurement> getTodayHistory(
        ...
        return waterService.getTodayHistory(deviceId);
    }
    ...
    public List<WaterMeasurement> getHistoryByRange(
        ...
        return waterService.getHistoryBetween(start, end, deviceId);
    }
    ...
    public WaterStatsDto getStatsByRange(
        ...
        return waterService.getStatsBetween(start, end, deviceId);
    }
}