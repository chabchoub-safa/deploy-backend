...
public class EnergyService {
    ...
    public List<EnergyMeasurement> getTodayHistory(String deviceId) {
        LocalDateTime start = LocalDate.now().atStartOfDay();
        LocalDateTime end = LocalDate.now().atTime(LocalTime.MAX);
    ...
    public List<EnergyMeasurement> getHistoryBetween(
            LocalDateTime start,
            LocalDateTime end,
            String deviceId
    ) {
    ...
    public EnergyStatsDto getStatsBetween(
            LocalDateTime start,
            LocalDateTime end,
            String deviceId
    ) {
        List<EnergyMeasurement> data = getHistoryBetween(start, end, deviceId);
